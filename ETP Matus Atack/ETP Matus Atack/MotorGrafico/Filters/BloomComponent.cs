...
namespace ETP_Matus_Atack 
{
    public class BloomComponent: DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = Game.Content.Load<Effect>("Assets_Graficos\\Bloom\\BloomExtract");
            bloomCombineEffect = Game.Content.Load<Effect>("Assets_Graficos\\Bloom\\BloomCombine");
            gaussianBlurEffect = Game.Content.Load<Effect>("Assets_Graficos\\Bloom\\GaussianBlur");
